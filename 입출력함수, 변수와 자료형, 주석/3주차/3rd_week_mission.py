...
'''
 nam=input("이름을 입력하세요")
 sen=input("지금하고 싶은 말은?")
 print(f"{nam}은 {sen}이라고 말했다")
'''
# print()
# print()
#전체선택 후 ctrl+?를 누르면 전체 주석 처리 가능
# [자료형]
# ※ 참고: 모두의 파이썬 68p
...
'''
print("아무것도 모르겠다..")
print('더도 말고 덜도 말고 한가위만 같으세요~')
print(type("아무것도 모르겠다.."))      #str
'''
