...
num1 = float(input('첫번째 숫자를 입력해주세요(숫자로 입력)>>'))
num2 = float(input('두번째 숫자를 입력해주세요(숫자로 입력)>>'))
print(num1 + num2)

## 예외처리 연습문제: 환율 계산 문제

try:
    won = float(input('원화 입력 ㄱㄱ'))
    dollar = float(input('달러 입력 ㄱㄱ'))

except ValueError as e:
    print('삐빅! 문자열 에러가 발생했습니다.', e)
