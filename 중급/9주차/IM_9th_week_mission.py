...
t.title("마리오의 별을 훔쳐먹은 거북이 게임(a.k.a. turtle 키보드 이벤트 처리 Mission)")# 프로그램 제목 설정
...
t.onkeypress(Spacebar, "space")# clean_bg 함수 이벤트 처리(onpress)
t.onkeypress(Esc, "Escape")# close_window 함수 이벤트 처리(onpress)
...
Window.geometry("1000x600+500+300")
