...
BABYSHARK = Shark("아기상어", 5000, 10000)
BABYSHARK.move()
...
wolf = Wolf('야생늑대', 10, 50)
wolf.move()

D = Dragon('투슬리스', 100000, 500000)
'''
...
class Dragon(Monster):
    ...
    def skill(self):
        print(f'[{self.skills[random.randit(0,2)]}]스킬을 사용했다! 효과는 굉장했다!')
