...
character1_name = '레넥톤'
character1_attack = 150
character1_health = 300
character1_speed = 299792458
...
character2_name = '에베베베베베베'
character2_attack = 100
character2_health = 3
character2_speed = 1
...
character3_name = '아 졸려'
character3_attack = 30
character3_health = 1
character3_speed = 0
...
## >> 캐릭터를 하나 만들 때마다 작성해야 하는 코드가 많고 복붙해서 수정하기도 귀찮다... 바로 그거다 클래스가 없으면 귀차니즘이 승리한다. 귀차니즘이 패배하기 위해선 클래스가 필요하다
...
C1 = Character('큐매 책벌레', 200, 200, 30)# 첫번째 캐릭터 만들기
C2 = Character('Gan 0507', 30, 40, 10)
C3 = Character('레오나르도 빚갚으리오', 100, 300, 50)# 두번째 캐릭터 만들기
