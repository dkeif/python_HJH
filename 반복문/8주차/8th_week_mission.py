...
n = 500
bgcolor = ['red', 'pink', 'brown', 'orange', 'yellow', 'green', 'skyblue', 'blue', 'navy', 'violet', 'purple', 'black', 'white']
color = ['red', 'pink', 'brown', 'orange', 'yellow', 'green', 'skyblue', 'blue', 'navy', 'violet', 'purple', 'black', 'white']
t.speed(0)
...
while count <= 9:
    user_num = int(input("1에서 1000까지의 숫자를 입력해주세요>>"))
    count += 1
    if random_num == user_num:
        print("정답 축! Congradulations!!")
        break
...
for i in range(7):
    t.setheading(90)
    t.penup()
    t.setpos(rainbow_size-(i*pen_size), 0)
